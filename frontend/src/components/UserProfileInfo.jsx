...
const UserProfileInfo = ({user, posts, profileId, setShowEdit}) => {
    ...
    <div className='relative py-4 px-6 md:px-8 bg-white'>
          <div className='flex flex-col md:flex-row items-start gap-6'>
            ...
            <div className='relative w-32 h-32 border-4 border-white shadow-lg -mt-20
            rounded-full flex-shrink-0'>
             <img src={user.profile_picture} alt="" className='w-full h-full rounded-full
             object-cover' />            
            </div> 
                ...
                <div className='flex flex-col md:flex-row items-start justify-between'>
                 <div>
                  ...
                  {!profileId  && 
                    ...
                    border-gray-300 hover:bg-gray-50 px-4 py-2 rounded-lg
                    font-medium transition-colors mt-4 md-md:mt-0 cursor-pointer'>
