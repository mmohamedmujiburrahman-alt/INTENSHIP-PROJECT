    ...
    const [editForm, setEditForm] = useState({
      ...
      const handleSaveProfile = async (e) => {
        ...
        try {
            ...
            const {full_name, username, bio, location, profile_picture,
                 cover_photo} = editForm
            ...
            dispath(updateUser({userData, token}))
                ...
                <div className='bg-white rounded-lg shadow p-6'>
                    ...
                    <form className='space-y-4' onSubmit={e=> toast.promise(
                            ...
                            <label htmlFor="cover_photo" className='block text-sm font-medium text-gray-700 mb-1'>
                                ...
                                <div className='group/cover relative'>
                                  <img src={editForm.cover_photo ? URL.createObjectURL(editForm.cover_photo) : user.cover_photo} alt="" 
                                   ...
                                   <div className="absolute hidden group-hover/cover:flex top-0 left-0 right-0 bottom-0 bg-black rounded-lg items-center justify-center">
                                      <Pencil className="w-5 h-5 text-white"/>
                                   </div>
                                </div>
                            </label>
                      ...
                      <div className='flex justify-end space-x-3 pt-6'>
                        ...
                        <button type='submit' className='px-4 py-2 bg-gradient-to-r from-indigo-500 to-purple-500 text-white rounded-lg hover:from-indigo-600
