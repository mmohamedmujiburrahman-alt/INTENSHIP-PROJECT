...
const CreatePost = () => {
    ...
    return (
    <div className='min-h-screen bg-gradient-to-b from-slate-50 to-while'>
       <div className='max-w-6xl mx-auto p-6'>
          ...
          {/* From */}
          <div className='max-wxl bg-white p-4 sm:p-8 sm:pb-3 rounded-xl shadow-md
          space-y-4'>
            {/* Header */}
            ...
            outline-none placeholder-gray-400' placeholder="What' happening? "
            onChange={(e)=>setContent(e.target.value)} value={content}/>

            {/* Images */}
            {
                images.length > 0 && <div className='flex flex-wrap gap-2 mt-4s'>
                    {images.map((image, i)=>(
